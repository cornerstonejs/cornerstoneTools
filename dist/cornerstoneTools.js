...
exports.magnify2TouchDrag = exports.magnify2 = undefined;
...
function drawMagnificationTool(eventData) {
  var magnify = _externalModules.external.$(eventData.element).find('.magnifyTool').get(0);
  ...
  var config = magnify2.getConfiguration();
...
function drawZoomedElement(e, eventData) {
  ...
  if (enabledElement === undefined) {
    enabledElement = _externalModules.external.cornerstone.getEnabledElement(eventData.element);
  }
  var config = magnify2.getConfiguration();
  ...
  _externalModules.external.cornerstone.setViewport(zoomElement, viewport);
}

function removeZoomElement() {
  if (zoomElement !== undefined) {
    _externalModules.external.cornerstone.disable(zoomElement);
...
function enable(element) {
  var config = magnify2.getConfiguration(config);
...
var _magnify2 = __webpack_require__(66);

Object.defineProperty(exports, 'magnify2', {
  enumerable: true,
  get: function get() {
    return _magnify2.magnify2;
  }
});
Object.defineProperty(exports, 'magnify2TouchDrag', {
  enumerable: true,
  get: function get() {
    return _magnify2.magnify2TouchDrag;
  }
});
