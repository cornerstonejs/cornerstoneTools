...
describe('HeightTool.js', () => {
  describe('default values', () => {
    it('has a default name of "Height"', () => {
      const defaultName = 'Height';
      const instantiatedTool = new HeightTool();
    ...
    it('can be created with a custom tool name', () => {
      ...
      const instantiatedTool = new HeightTool(customToolName);
  ...
  describe('createNewMeasurement', () => {
    it('emits console error if required eventData is not provided', () => {
      const instantiatedTool = new HeightTool('toolName');
  ...
  describe('updateCachedStats', () => {
    ...
    it('should calculate and update annotation value', () => {
      ...
      expect(data.length.toFixed(2)).toEqual('47.40');
      ...
      instantiatedTool.updateCachedStats(image, element, data);
      expect(data.length.toFixed(2)).toEqual('44.77');
    });
  });
