...
const logger = getLogger('tools:annotation:HeightTool');

/**
 * @public
 * @class HeightTool
 * @memberof Tools.Annotation
 * @classdesc Tool for measuring height.
 * @extends Tools.Base.BaseAnnotationTool
 */
export default class HeightTool extends BaseAnnotationTool {
  // Constructor
  constructor(props = {}) {
    const defaultProps = {
      name: 'Height',
  ...
  renderToolData(evt) {
    ...
    for (let i = 0; i < toolData.data.length; i++) {
      ...
      draw(context, context => {
        ...
        // Draw the measurement line height
        drawHeight(
          context,
          element,
          data.handles.start,
