...
const freehandSculpterCursor = `<svg
    data-icon="freehandSculpter" role="img" xmlns="http://www.w3.org/2000/svg"
    width="32" height="32" viewBox="0 0 18 18"
  >
  <g id="icon-freehand-sculpt" fill="none" stroke-width="1.5" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round">
