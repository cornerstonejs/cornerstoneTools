...
describe('FreehandTool.js', function () {
  beforeEach(() => {
  ...
  describe('default values', () => {
    it('has a default name of "Freehand"', () => {
      const defaultName = 'Freehand';
      const instantiatedTool = new FreehandTool();
    ...
    it('can be created with a custom tool name', () => {
      ...
      const instantiatedTool = new FreehandTool(customToolName);
