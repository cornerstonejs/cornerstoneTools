...
- [Tool Types](tool-types/index.md)
  ...
  - [Base Segmentation Tool](tool-types/index.md#base-segmentation-tool)
- [Tool Mixins](tool-mixins/index.md)
  - [Binary Tools](tool-mixins/index.md#binary-tools)
  - [Segmentation API](tool-mixins/index.md#segmentation-API)
  - [Segmentation Tools](tool-mixins/index.md#segmentation-mixins)
